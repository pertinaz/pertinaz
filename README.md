...
# Tech Stack: 
[![Stack](https://skillicons.dev/icons?i=react,flutter,tailwind,css,astro,next,vite,nodejs,nestjs,expressjs,npm,pnpm,webpack,nginx&perline=4)](https://skillicons.dev)

# ‎  
[![so](https://skillicons.dev/icons?i=windows,linux,kali,mint,,ubuntu,arch,vscode,vim&perline=5)](https://skillicons.dev)
